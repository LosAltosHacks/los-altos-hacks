...
!(function(a, b) {
    ...
    function ea(a, b) {
        return a
            ? c(this._months)
                ...
                : this._months[
                      (this._months.isFormat || fe).test(b)
                          ? 'format'
                          : 'standalone'
                  ][a.month()]
            : this._months;
    ...
    function fa(a, b) {
        return a
            ? c(this._monthsShort)
                ...
                : this._monthsShort[fe.test(b) ? 'format' : 'standalone'][
                      a.month()
                  ]
            : this._monthsShort;
    }
        ...
        for (e = X(b._f, b._locale).match(Bd) || [], c = 0; c < e.length; c++)
            (f = e[c]),
                ...
                d &&
                    ...
                    (j += d.length)),
                Ed[f]
                    ? (d ? (l(b).empty = !1) : l(b).unusedTokens.push(f),
                      ca(f, d, b))
    ...
    function Ab(b, c) {
        ...
        return c._isUTC
            ? ((d = c.clone()),
              (e =
                  (r(b) || f(b) ? b.valueOf() : rb(b).valueOf()) - d.valueOf()),
