        ...
        this.each(function() {
            ...
            if (!id || delimiter[$(this).attr('id')]) {
                id = $(this)
                    .attr(
                        'id',
                        'tags' + new Date().getTime() + uniqueIdCounter++
                    )
                    .attr('id');
            }
            ...
            if (settings.interactive) {
                ...
                if (settings.autocomplete_url != undefined) {
                    ...
                    for (attrname in settings.autocomplete) {
                        autocomplete_options[attrname] =
                            settings.autocomplete[attrname];
                    }
                    ...
                    if (jQuery.Autocompleter !== undefined) {
                        ...
                        $(data.fake_input).bind('result', data, function(
                            event,
                            data,
                            formatted
                        ) {
                ...
                if (data.unique) {
                    $(data.fake_input).keydown(function(event) {
                        if (
                            event.keyCode == 8 ||
                            String.fromCharCode(event.which).match(
                                /\w+|[áéíóúÁÉÍÓÚñÑ,/]+/
                            )
                        ) {
